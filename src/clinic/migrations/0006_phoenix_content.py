...
SERVICES = [
    ...
    },
    {
        ...
        'short_description': 'УЗД, рентген, КТ',
        'full_description': (
    ...
    },
    {
        ...
        'icon': 'scan',
        'bullets': ['Гастроскопія', 'Колоноскопія', 'Бронхоскопія', 'Мінімально інвазивно'],
        'is_urgent': False,
        'order': 6,
    },
    {
    ...
    },
    {
        ...
        'icon': 'stethoscope',
        'bullets': ['Огляд шкіри', 'Соскопи', 'Алергологічні тести', 'План лікування'],
        'is_urgent': False,
        'order': 11,
    },
]
